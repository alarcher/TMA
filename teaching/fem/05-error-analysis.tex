...
The interpolation inequality of Proposition \ref{prpstn:interpolation_pk} only applies with $s = 0$ so that the convergence order is only one in $\xLtwo$ norm in the general case.
...
- \Lap \varphi(\xx) = e_h(\x)\quad,\;\xx\in\dom
\end{equation}
