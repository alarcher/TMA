...
The interpolation inequality of Proposition \ref{prpstn:interpolation_pk} only applies in the general case with $s = 0$ so that the convergence order is only one in $\xLtwo$.
